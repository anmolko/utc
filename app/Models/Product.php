...
class Product extends Model
{
    ...
    protected $fillable =['id','name','slug','brand','status','image','thumbnail','summary','description','primary_category_id','secondary_category_id','information','created_by','updated_by'];
