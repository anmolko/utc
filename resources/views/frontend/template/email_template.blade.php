            ...
            <table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
                <tr>
                    <td colspan="4" valign="top" class="image-section" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;background-color: #fff;border-bottom: 4px solid #2f358b">
                        <a href="https://universaltrading.com.np/"><img class="top-image" src="{{asset('/images/uploads/settings/'.@$data['logo'])}}" style="line-height: 1;max-width: 100%;height: auto;padding-bottom: 10px;" alt="universaltrading"></a>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td class="inside-footer" align="center" valign="middle" style="border-collapse: collapse;border: 0;margin: 0;padding: 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 12px;line-height: 16px;vertical-align: middle;text-align: center;width: 580px;">
                                    <div id="address" class="mktEditable">
                                        ...
                                        <a style="color: #2f358b;" href="https://universaltrading.com.np/contact-us">Contact Us</a>
                                    </div>
                                </td>
                            </tr>
                        </table>
