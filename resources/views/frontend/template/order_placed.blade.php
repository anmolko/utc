                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="370" align="left">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-menu" esd-img-prev-h="16" esd-img-prev-w="13" esd-tmp-menu-padding="33|10">
                                                                                        <table class="es-menu" width="100%" cellspacing="0" cellpadding="0">
                                                                                            <tbody>
                                                                                                <tr class="links">
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l" style="padding-bottom: 10px; padding-top: 33px;" width="33.33%" bgcolor="transparent" align="center"><a style="color: #333333; font-size: 16px;" href="https://universaltrading.com.np/poduct" target="_blank">Shop</a></td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l" style="padding-bottom: 10px; padding-top: 33px;" width="33.33%" bgcolor="transparent" align="center"><a style="color: #333333; font-size: 16px;" href="https://universaltrading.com.np/blog" target="_blank">Blog</a></td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l" style="padding-bottom: 10px; padding-top: 33px;" width="33.33%" bgcolor="transparent" align="center"><a style="color: #333333; font-size: 16px;" href="https://universaltrading.com.np/contact" target="_blank">Contact</a></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p5t es-p5b es-p40r es-p40l" align="center">
                                                                                        <p style="color: #333333;">&nbsp;If you have any questions, Call us 9851161380.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p15t es-p10b" align="center"><span class="es-button-border" style="border-radius: 5px; background: #d48344 none repeat scroll 0% 0%; border-style: solid; border-color: #2cb543; border-top: 0px solid #2cb543; border-bottom: 0px solid #2cb543;"><a href="https://universaltrading.com.np/my-order" class="es-button" target="_blank" style="font-size: 16px; border-top-width: 10px; border-bottom-width: 10px; border-radius: 5px; background: #d48344 none repeat scroll 0% 0%; border-color: #d48344;">View Your Order</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                                        ...
                                                                                        <table style="width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;"> {{@$data['order_id']}}</span></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;">Order Date:</span></td>
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;">{{@$data['date']}}</span></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;">Order Total:</span></td>
                                                                                                    <td><span style="font-size: 14px; line-height: 150%;">NPR {{@$data['total_amount']}}</span></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                ...
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="1748" align="center">
                                        <table class="es-footer-body" width="600" cellspacing="0" cellpadding="0" align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p5" esd-general-paddings-checked="false" align="left">
                                                        <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="es-m-p0r es-m-p20b esd-container-frame" width="210" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p10t es-m-txt-c">
                                                                                        <p style="line-height: 150%; font-size: 12px;">
                                                                                            <a target="_blank" href style="line-height: 150%; font-size: 12px;" class="unsubscribe"></a><a target="_blank" href="tel:{{@$data['phone']}}">{{@$data['phone']}}</a><br><a target="_blank" href="mailto:{{@$data['site_email']}}">{{@$data['site_email']}}</a></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
