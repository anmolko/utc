...
@section('title') {{ucwords(@$brand_serie->name)}}  @endsection
@section('styles')
<style>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumbs">
                            ...
                            <li class="trail-end">
                                <a href="#" title="">{{ucwords(@$brand_serie->name)}}</a>
                            </li>
                        </ul><!-- /.breacrumbs -->
                    </div><!-- /.col-md-12 -->
                </div><!-- /.row -->
...
<script>
    $(document).ready(function(){
        ...
        function filter_data(page)
        {
            ...
            var pbrandseries = '{{$brand_serie->slug}}';

            var s = $('.searchby').val();
            var url = '{{ route("product.brandseriesfilter") }}';
            $.ajax({
                url:"/product/filterseries?page="+page,
                data:{min_price:min_price,pattribute:pattribute,pbrand:pbrand,pbrandseries:pbrandseries,orderby:orderby,max_price:max_price,s:s},
                type: 'get',
