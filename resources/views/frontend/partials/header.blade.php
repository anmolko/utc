...
<meta charset="utf-8">
    ...
    <meta name="description" content="@if(!empty(@$setting_data->website_description)) {{ucwords(@$setting_data->website_description)}} @else Webor Electronics @endif ">
    <link rel="canonical" href="https://weborelectronics.com/" />
    <title>@yield('title') - @if(!empty(@$setting_data->website_name)) {{ucwords(@$setting_data->website_name)}} @else Webor Electronics @endif </title>
    <meta property="og:title" content="Home" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://weborelectronics.com/" />
	<meta property="og:site_name" content="Webor Electronics" />
	<meta property="og:description" content="@if(!empty(@$setting_data->website_description)) {{ucwords(@$setting_data->website_description)}} @else Webor Electronics @endif " />
                                    ...
                                    <ul class="main-menu text-center">
                                        ...
                                        @if(!empty($top_nav_data))
                                            ...
                                            @elseif($nav->type == 'category') 
                                                <a href="{{url('product')}}/{{$nav->slug}}" class="{{request()->is(@$nav->slug.'*')  ? 'active' : ''}}">@if(@$nav->name == NULL) {{ucwords(@$nav->title)}} @else {{ucwords(@$nav->name)}} @endif </a>
                                            ...
                                            @endif 
                                                <ul class="dropdwn">
                                                    ...
                                                    @elseif($childNav->type == 'category')
                                                        <li>
                                                            <a href="{{url('product')}}/{{@$childNav->slug}}" class="{{request()->is('product/'.@$childNav->slug) ? 'active' : ''}}" >@if(@$childNav->name == NULL) {{@$childNav->title}} @else {{@$childNav->name}} @endif</a>
                                                        </li>
                                            ...
                                            @else
                                                ...
                                                @elseif($nav->type == 'category')
                                                <li >
                                                    <a href="{{url('product')}}/{{$nav->slug}}" class="{{request()->is('product/'.@$nav->slug.'*') ? 'active' : ''}}">@if($nav->name == NULL) {{$nav->title}} @else {{$nav->name}} @endif</a></li>
                                                @elseif($nav->type == 'post')
                                                <li >
