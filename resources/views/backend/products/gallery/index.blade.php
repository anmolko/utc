...
@section('title') {{ucwords(@$product->name)}} Gallery  @endsection
@section('css')
            ...
            <div class="card ctm-border-radius shadow-sm flex-fill">
                <div class="card-header">
                    <h4 class="card-title d-inline-block mb-0">
                        Add gallery for :: <strong>{{ucwords(@$product->name)}}</strong>
                    </h4>
                    <a href="{{route('products.index')}}" class="float-right add-doc text-primary">Go Back
                            </a>
                    <p class="text-danger">Note* Please add the images for detail page  </p>
                </div>
                <div class="card-body">
                    ...
                    {!! Form::open(['url'=>route('products-gallery.update', @$product->id),'method'=>'PUT','class'=>'dropzone','id'=>'myDropzone','enctype'=>'multipart/form-data']) !!}
