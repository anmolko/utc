...
(function($) {
    ...
    ******************************************** */
    ...
    /* ********************************************
    	Product Sildebar Accordion
    ******************************************** */

    $(".attribute-title").on("click", function() {
        $(this).toggleClass("active");
        $(this).next().slideToggle(200);
    });

    jQuery(window).load(function() {
        $(".single-attribute-title").toggleClass("active");
        $(".single-attribute-title").next().slideToggle(200);
    });


    $(".primary-category-title").on("click", function() {
        $(this).toggleClass("active");
        $(this).next().slideToggle(200);
    });
...
function sticky_relocate() {
    ...
    var footer_top = $("#footer").offset().top - 20;
    ...
    if ($('#sticky-anchor').length) {
        ...
        if (window_top + div_height > footer_top) {
            $('.sidebar').removeClass('make-me-sticky');
            // $('.sidebar').addClass('sidebar-item');
            $('.right-container').css('min-height', leftHeight + 'px');
        } else if (window_top > div_top) {
            $('.sidebar').addClass('make-me-sticky');
            // $('.sidebar').removeClass('sidebar-item');
        } else {
            $('.sidebar').removeClass('make-me-sticky');
            // $('.sidebar').removeClass('sidebar-item');
        }
